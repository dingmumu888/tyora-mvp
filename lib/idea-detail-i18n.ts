...
const en = {
  ...
  share: "Share",
  report: "Report",
  reportTitle: "Report this discussion",
  reportPrompt: "Tell TYORA what is unsafe, misleading, or inappropriate.",
  reportPlaceholder: "Describe the concern (10–500 characters)…",
  submitReport: "Send report",
  reportSent: "Thanks. TYORA will review this report.",
  edit: "Edit",
  withdraw: "Withdraw",
...
const zhCN: Dictionary = {
  ...
  report: "举报",
  reportTitle: "举报这篇帖子",
  reportPrompt: "请告诉 TYORA 哪些内容存在安全、误导或不当问题。",
  reportPlaceholder: "说明具体问题（10–500 字）……",
  submitReport: "提交举报",
  reportSent: "已收到，TYORA 会检查这条举报。",
  edit: "编辑",
  withdraw: "撤回",
  joinDiscussion: "加入讨论",
...
const es: Dictionary = {
  ...
  report: "Reportar", reportTitle: "Reportar esta publicación", reportPrompt: "Indica a TYORA qué contenido es inseguro, engañoso o inapropiado.", reportPlaceholder: "Describe el problema (10–500 caracteres)…", submitReport: "Enviar reporte", reportSent: "Gracias. TYORA revisará este reporte.",
...
const fr: Dictionary = {
  ...
  report: "Signaler", reportTitle: "Signaler cette discussion", reportPrompt: "Indiquez à TYORA ce qui est dangereux, trompeur ou inapproprié.", reportPlaceholder: "Décrivez le problème (10 à 500 caractères)…", submitReport: "Envoyer le signalement", reportSent: "Merci. TYORA examinera ce signalement.",
...
const de: Dictionary = {
  ...
  report: "Melden", reportTitle: "Diesen Beitrag melden", reportPrompt: "Teile TYORA mit, was unsicher, irreführend oder unangemessen ist.", reportPlaceholder: "Problem beschreiben (10–500 Zeichen)…", submitReport: "Meldung senden", reportSent: "Danke. TYORA prüft diese Meldung.",
...
const pt: Dictionary = {
  ...
  report: "Denunciar", reportTitle: "Denunciar esta discussão", reportPrompt: "Informe à TYORA o que é inseguro, enganoso ou impróprio.", reportPlaceholder: "Descreva o problema (10–500 caracteres)…", submitReport: "Enviar denúncia", reportSent: "Obrigado. A TYORA analisará esta denúncia.",
