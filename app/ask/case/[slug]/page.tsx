    ...
    <main className="min-h-screen overflow-x-hidden bg-[radial-gradient(circle_at_top_left,#eef6ff_0,#f6f7fb_38%,#f7f5f0_100%)] pb-28 text-[#101216]">
      ...
      <article className="mx-auto max-w-3xl space-y-3 px-3 py-3 sm:px-5">
        <section className="rounded-[24px] border border-[#e4e8ef] bg-white p-4 shadow-sm">
          <div className="flex flex-wrap gap-2 text-xs font-semibold"><span className="rounded-full bg-[#edf4ff] px-2.5 py-1 text-[#2563eb]"><CommunityText text={story.category} /></span><span className="rounded-full bg-[#f4f6f8] px-2.5 py-1 text-[#667085]"><CommunityText text={story.status} /></span>{story.projectType === "Demonstration Project" ? <span className="rounded-full bg-[#fff7d6] px-2.5 py-1 text-[#8a5a00]"><CommunityText text="Demonstration Project" /></span> : <span className="rounded-full bg-[#e8f8ef] px-2.5 py-1 text-[#15803d]">Real Project</span>}</div>
          <h1 className="mt-4 text-2xl font-semibold leading-tight sm:text-3xl"><CommunityText text={story.name} /></h1>
          <p className="mt-3 text-base leading-7 text-[#343b47]"><CommunityText text={story.shortDescription} /></p>
